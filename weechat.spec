...
Source0  : https://weechat.org/files/src/weechat-4.1.0.tar.xz
Source1  : https://weechat.org/files/src/weechat-4.1.0.tar.xz.asc
...
%prep
%setup -q -n weechat-4.1.0
cd %{_builddir}/weechat-4.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697572136
mkdir -p clr-build
pushd clr-build
