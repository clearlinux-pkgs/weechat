...
Version  : 4.3.5
Release  : 56
URL      : https://weechat.org/files/src/weechat-4.3.5.tar.gz
Source0  : https://weechat.org/files/src/weechat-4.3.5.tar.gz
Source1  : https://weechat.org/files/src/weechat-4.3.5.tar.gz.asc
...
%setup -q -n weechat-4.3.5
cd %{_builddir}/weechat-4.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721240049
mkdir -p clr-build
pushd clr-build
