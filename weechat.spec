...
Source0  : https://weechat.org/files/src/weechat-3.4.tar.xz
Source1  : https://weechat.org/files/src/weechat-3.4.tar.xz.asc
...
%prep
%setup -q -n weechat-3.4
cd %{_builddir}/weechat-3.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640194961
...
cp %{_builddir}/weechat-3.4/COPYING %{buildroot}/usr/share/package-licenses/weechat/31a3d460bb3c7d98845187c716a30db81c44b615
%make_install
%find_lang weechat
