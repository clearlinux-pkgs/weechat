...
Version  : 4.0.2
Release  : 52
URL      : https://weechat.org/files/src/weechat-4.0.2.tar.xz
Source0  : https://weechat.org/files/src/weechat-4.0.2.tar.xz
Source1  : https://weechat.org/files/src/weechat-4.0.2.tar.xz.asc
...
%prep
%setup -q -n weechat-4.0.2
cd %{_builddir}/weechat-4.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689795273
mkdir -p clr-build
pushd clr-build
