...
Version  : 4.7.0
Release  : 70
URL      : https://weechat.org/files/src/weechat-4.7.0.tar.gz
Source0  : https://weechat.org/files/src/weechat-4.7.0.tar.gz
Source1  : https://weechat.org/files/src/weechat-4.7.0.tar.gz.asc
...
%setup -q -n weechat-4.7.0
cd %{_builddir}/weechat-4.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1753109052
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/weechat-%{version}/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/weechat/7d742d725c74463f26afc2c6b7433dff4296a315 || :
cp %{_builddir}/weechat-%{version}/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/weechat/d731920113454e58292b53feedd262e531cae0f1 || :
export GOAMD64=v2
GOAMD64=v2
pushd clr-build
%make_install
...
/usr/share/package-licenses/weechat/7d742d725c74463f26afc2c6b7433dff4296a315
/usr/share/package-licenses/weechat/d731920113454e58292b53feedd262e531cae0f1
