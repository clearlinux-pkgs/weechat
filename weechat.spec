...
Source0  : https://weechat.org/files/src/weechat-4.5.2.tar.gz
Source1  : https://weechat.org/files/src/weechat-4.5.2.tar.gz.asc
...
%setup -q -n weechat-4.5.2
cd %{_builddir}/weechat-4.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740154773
mkdir -p clr-build
pushd clr-build
