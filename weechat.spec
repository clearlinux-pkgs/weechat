...
Source0  : https://weechat.org/files/src/weechat-4.3.6.tar.gz
Source1  : https://weechat.org/files/src/weechat-4.3.6.tar.gz.asc
...
%setup -q -n weechat-4.3.6
cd %{_builddir}/weechat-4.3.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723730545
mkdir -p clr-build
pushd clr-build
