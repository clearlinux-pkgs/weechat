...
Source0  : https://weechat.org/files/src/weechat-4.4.3.tar.gz
Source1  : https://weechat.org/files/src/weechat-4.4.3.tar.gz.asc
...
%setup -q -n weechat-4.4.3
cd %{_builddir}/weechat-4.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730328962
mkdir -p clr-build
pushd clr-build
